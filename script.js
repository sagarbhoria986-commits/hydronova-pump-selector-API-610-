...
// =====================================================
    ...
    description =
        "None of the standard API 610 configurations match the entered operating conditions. Review flow, head, pressure, temperature and NPSHA values, or consult an application engineer for a custom-engineered pump.";
